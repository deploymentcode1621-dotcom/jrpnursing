  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-16 bg-[#25D366] text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition">
          WhatsApp
        </span>
      </a>
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-16 bg-blue-600 text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition">
          Call Now
        </span>
      </a>
